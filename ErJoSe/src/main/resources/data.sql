...
-- Cursos
INSERT INTO courses (id, title, description, creation_date, last_update_date, image_url, current_price, available, category_id, language_id)
VALUES
    -- Cursos de Desarrollo Web
    ('a40edb92-17b3-4f3a-9758-9df565aa04f0', 'Diseño Web Inspirador: Más Allá de las Tendencias', 'Descubre cómo crear diseños web innovadores que van más allá de las tendencias actuales.', current_date, current_date, '/images/inspiring_web_design.jpg', 59.99, true, '1', '2'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f1', 'Optimización de Rendimiento en Desarrollo Web', 'Aprende a optimizar el rendimiento de tus aplicaciones web para una experiencia de usuario excepcional.', current_date, current_date, '/images/web_performance.jpg', 59.99, true, '1', '2'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f2', 'Desenvolupament d´Aplicacions Web Progressives amb React', 'Aprèn a crear aplicacions web progressives alt rendiment utilitzant React i PWA.', current_date, current_date, '/images/pwa_react.jpg', 69.99, true, '1', '3'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f3', 'Desarrollo Web Responsivo para Dispositivos Móviles', 'Crea sitios web que se adapten perfectamente a cualquier dispositivo, desde smartphones hasta tablets.', current_date, current_date, '/images/responsive_web.jpg', 49.99, true, '1', '2'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f4', 'Conception Web Inspirante: Au-delà des Tendances', 'Découvrez comment créer des designs web innovants qui vont au-delà des tendances actuelles.', current_date, current_date, '/images/inspiring_web_design.jpg', 64.99, true, '1', '4'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f5', 'Seguridad Web Avanzada: Protegiendo tus Aplicaciones', 'Domina las técnicas et les outils pour assurer la sécurité de tes applications web.', current_date, current_date, '/images/web_security.jpg', 64.99, true, '1', '4'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f6', 'Amazing CSS and JavaScript Web Animations', 'Create stunning animations for your websites using CSS and JavaScript.', current_date, current_date, '/images/web_animations.jpg', 49.99, true, '1', '1'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f7', 'Full-Stack Web Development with Spring Boot 3 & React', 'Build full-stack web applications using Java, Spring Boot 3, Spring Data JPA, Spring Security, JWT, JavaScript, React JS & MySQL.', current_date, current_date, '/images/nodejs.jpg', 64.99, true, '1', '1'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f8', 'Erstaunliche Animationen mit CSS und JavaScript', 'Erstellen Sie beeindruckende Animationen für Ihre Websites mit CSS und JavaScript.', current_date, current_date, '/images/web_animations.jpg', 59.99, true, '1', '5'),
    ('a40edb92-17b3-4f3a-9758-9df565aa04f9', 'Arquitecturas de Microservicios en Desarrollo Web', 'Explora la arquitectura de microservicios und cómo implementarla en el desarrollo web.', current_date, current_date, '/images/microservices.jpg', 69.99, true, '1', '2'),
